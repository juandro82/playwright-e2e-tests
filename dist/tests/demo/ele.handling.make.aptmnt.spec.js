...
test_1.test.describe("Make appointmenmt", () => {
    ...
    (0, test_1.test)("Should make an appointment with non-default values", async ({ page, }) => {
        ...
        await (0, test_1.expect)(page.getByLabel("Facility")).toHaveValue("Tokyo CURA Healthcare Center");
        await page
            .getByLabel("Facility")
        ...
        await (0, test_1.expect)(drpdwnOptionsEle).toHaveCount(3);
        ...
        await (0, test_1.expect)(page.getByText("Medicare")).toBeChecked();
        await page.getByRole("radio", { name: "Medicaid" }).check();
        await (0, test_1.expect)(page.getByText("Medicare")).not.toBeChecked();
        //Date input box
